...
import ian.com.saying.model.Comment;
...
public class PostDetailActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Initialize Views
        mLayoutView = findViewById(R.id.rl_postDetail);
    ...
    private static class CommentViewHolder extends RecyclerView.ViewHolder {
        ...
        public CommentViewHolder(View itemView) {
            ...
            deleteView = itemView.findViewById(R.id.cDelete);
        }
    }
        ...
        public void onBindViewHolder(final CommentViewHolder holder, final int position) {
            ...
            holder.deleteView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    ab.setMessage("댓글을 삭제하시겠어요?");
                    ab.setCancelable(false);
                    ab.setPositiveButton("삭제", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            comment.text = "삭제된 댓글입니다.";
                            mDatabaseReference.child(mCommentIds.get(position)).setValue(comment);
//                            mDatabaseReference.child(mCommentIds.get(position)).updateChildren("text", "삭제된 댓글입니다.");
                            ;
                        }});
